...
MESH_FOLDER = "/home/fbottarel/workspace/mesh_pc_render/models"
OUT_DIRECTORY = "/home/fbottarel/workspace/mesh_pc_render/partial_pc"
...
CAMERA_VIEWPOINT = np.array([0.8, 0.0, 0.8])
NUMBER_SAMPLED_POINTS = 500


def renderMesh(mesh, cam_viewpoint, number_sampled_points):
    """
...
def main():
    ...
    for obj in object_dirlist:
        ...
        points, points_transformed = renderMesh(mesh, CAMERA_VIEWPOINT, NUMBER_SAMPLED_POINTS)
